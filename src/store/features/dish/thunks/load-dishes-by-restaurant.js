import { failLoadingDishes, finishLoadingDishes, startLoadingDishes } from "../action";

export const loadDishesByRestaurantIfNotExist = (restaurantId) => (dispatch, getState) => {
  // if( condition ) {
  //   return ;
  // }
